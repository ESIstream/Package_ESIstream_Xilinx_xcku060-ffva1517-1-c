...
if { [lindex $argv 0] == 0 | $argc != 1 } {
    ...
    add_files $path_src_tx_rx_ip/tx_rx_xcvr_wrapper_16b.vhd
    add_files $path_src_rx_ip/rx_output_buffer_wrapper.vhd
    add_files $path_src_pkg/esistream_pkg_16b.vhd
    ...
    add_files -fileset constrs_1 $path_xdc/${synth_top}_16b.xdc

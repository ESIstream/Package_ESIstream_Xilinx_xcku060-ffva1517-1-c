...
puts $path_src
set package_reference xilinx_ku060
...
if { [lindex $argv 0] == 0 | $argc != 1 } {
    ...
    add_files $path_src_common/ila_wrapper_32b.vhd
    add_files $path_src/../src_odelaye3/odelaye3_wrapper.vhd
    add_files $path_src_rx/
    add_files $path_src_rx_ip/rx_xcvr_wrapper_32b_dl.vhd
    add_files $path_src_rx_ip/rx_output_buffer_wrapper.vhd
    add_files $path_src_pkg/esistream_pkg_32b.vhd
    ...
    add_files -fileset constrs_1 $path_xdc/${synth_top}_32b.xdc
